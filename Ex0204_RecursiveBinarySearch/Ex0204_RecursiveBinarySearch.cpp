...
int RecurBinarySearch(int* arr, int left, int right, int x) // n 대신에 left, right
{
	if (left <= right)
	{
		...
		{
<<<<<<< HEAD
			return RecurBinarySearch(arr, left, right -1, x); // TODO:
		}
		else if (x > arr[middle])
		{
			return RecurBinarySearch(arr, left+1, right, x); // TODO:
		}
		else
		{
			return middle; // TODO:
=======
		...
		{
			return -1; // TODO:
>>>>>>> 6d7c7ccc7d2da609ad9c80e465657b8404ee3da5
		}
	}
...
<<<<<<< HEAD
	...
	cout << RecurBinarySearch(arr, 0, n - 1, 4) << endl;
=======
